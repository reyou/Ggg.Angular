...
$destination = "D:\Git\Ggg.Github\Ggg.Angular\apps\apps-books\Pro-Angular-6-3rd-Edition\part3-advanced-angular-features\chap26-Routing-and-Navigation-Part-2\intro1-Preparing-the-Example-Project";
