...
$destination = "D:\Git\Ggg.Github\Ggg.Angular\apps\apps-books\Pro-Angular-6-3rd-Edition\part3-advanced-angular-features\chap29-Angular-Unit-Testing\intro1-Preparing-the-Example-Project";
