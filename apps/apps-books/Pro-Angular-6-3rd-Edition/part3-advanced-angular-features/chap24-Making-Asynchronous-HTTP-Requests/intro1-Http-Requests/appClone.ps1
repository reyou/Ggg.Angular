...
$destination = "C:\Ggg\Ggg.Angular\apps\apps-books\Pro-Angular-6-3rd-Edition\part3-advanced-angular-features\chap23-Using-Reactive-Extensions\intro2-Going-Beyond-the-Basics";
