...
let PaAddTaxPipe = class PaAddTaxPipe {
    /* Pipes are classes to which the @Pipe decorator has been applied and that implement a method called
    transform. The @Pipe decorator defines two properties, which are used to configure pipes. */
    constructor() {
        this.defaultRate = 10;
    }
    transform(value, rate) {
...
PaAttrDirective.ctorParameters = () => [
...
let PaCategoryFilterPipe = class PaCategoryFilterPipe {
...
let PaCellColor = class PaCellColor {
    constructor() {
...
PaIteratorDirective.ctorParameters = () => [
...
let PaStructureDirective = class PaStructureDirective {
    constructor(
...
PaStructureDirective.ctorParameters = () => [
    { type: _angular_core__WEBPACK_IMPORTED_MODULE_1__["ViewContainerRef"] },
    { type: _angular_core__WEBPACK_IMPORTED_MODULE_1__["TemplateRef"] }
];
tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
...
let PaToggleView = class PaToggleView {
    constructor() {
